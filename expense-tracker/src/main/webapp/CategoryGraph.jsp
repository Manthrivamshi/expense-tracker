...
@
keyframes graph {from { transform:rotateY(90deg);
...
<body>
	<div class="header">
		<a href="index.jsp"> <img
			src="media/expenses-removebg-preview (1).png"
			style="height: 47px; width: 47px; padding: 22px; margin-left: 33px;">
		</a> <b>Spring Expenses Tracker</b> <a href="home.jsp" id="dd"><i
	...
	<br>
	<br>
	<a href="ViewExpenses" style="position: absolute; top: 14%; right: 3%;"><button
			style="width: 90px;">BACK</button></a>
	<canvas id="myChart" width="700" height="200"></canvas>
	<script>
		var xValues = [ "utilities", "Transportation", "Groceries",
				"Dining Out", "Entertainment", "Health Care", "Education",
				"personal care", "Clothing", "Home Maintanence",
				"Gifts & Donations", "Savings &Investments", "Tax", "Others" ];
		var yValues = [
	<%=utilitiesAmount%>
		,
	<%=transportAmount%>
	...
	<center>
		<div id="vd"
			style="z-index: 19; border-style: solid; position: absolute; top: 15%; left: 26%; display: none; background-color: white;">
			<table border="2" style="height: 130px; width: 690px;">
				<tr>
					<th colspan="3" align="center">AMOUNT SPENT TILL DATE =
						&#8377; <%=totalAmount%></th>
				</tr>
				...
				<tr>
					<td>7</td>
					<td>Education</td>
					<td>&#8377; <%=educationAmount%></td>
				</tr>
				<tr>
					<td>8</td>
					<td>Personal Care</td>
					<td>&#8377; <%=personalCareAmount%></td>
				</tr>
				<tr>
					<td>9</td>
					<td>Clothing</td>
					<td>&#8377; <%=clothingAmount%></td>
				</tr>
				<tr>
					<td>10</td>
					<td>Home Maintanence</td>
					<td>&#8377;<%=HomeAmount%>
					</td>
				</tr>
				<tr>
			...
			<button id="close"
				style="width: 690px; align: center; height: 29px; background-color: red; border-radius: 0px;"
	...
	<center>
		<h2
			style="color: red; text-shadow: 1px 1px white; letter-spacing: 1px; word-spacing: 2px;">
			TOTAL AMOUNT SPENT TILL DATE = &#8377;
			<%=totalAmount%></h2>
		<br>
		<button onclick="showDetails();">VIEW AMOUNT SPENT ON EACH
			CATEGORY</button>
	</center>
