...
<body>
	...
	%>
	<div id="fffrm">
		<form method="post" action="SendExpenses">
			<br>
			<center>
				<h4>SEND MY EXPENSES VIA EMAIL</h4>
			</center>
			<br> <br> <input type="text" hidden=true
				value=<%=user.getUserId()%> name="uid"> <label>USERNAME
			</label><br>
			<center>
			...
			<br> <input type="checkbox" name="agree" required id="chb"><span
				style="float: right; color: white; font-style: normal; margin-right: 286px; margin-top: 10px; font-size: medium;">click
				here to agree</span>

			<div class="trm">
				<span>After clicking the submit button you will recieve your
					expenses details through email within 24 hours</span>
			</div>
			<br>
			<center>
				<button type="submit">Send My Expenses</button>
			</center>
		</form>
